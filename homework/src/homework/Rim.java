...
public class Rim extends Agent {
	...
	public Rim(String opinion, String conformism, int i, int j) {
	...
	public void polling_neighbors() {
		...
		if (this.getI() == 0 & this.getJ() == 0) {
			...
			this.setMopin_bottom_right(agents[this.getI() + 1][this.getJ() + 1].getOpinion());
		}
		if (this.getI() == 0 & this.getJ() != (agents[this.getI()].length - 1) & this.getJ() != 0) {
			...
			this.setMopin_bottom_right(agents[this.getI() + 1][this.getJ() + 1].getOpinion());
			this.setMopin_bottom_light(agents[this.getI() + 1][this.getJ() - 1].getOpinion());
		}
		...
		if (this.getJ() == 0 & this.getI() != 0 & this.getI() != (agents.length - 1)) {
			...
			this.setMopin_top_right(agents[this.getI() - 1][this.getJ() + 1].getOpinion());
			this.setMopin_bottom_right(agents[this.getI() + 1][this.getJ() + 1].getOpinion());
		...
		if ((this.getI() == agents.length - 1) & this.getJ() != 0 & this.getJ() != (agents[this.getI()].length - 1)) {
			...
			this.setMopin_top(agents[this.getI() - 1][this.getJ()].getOpinion());
			this.setMopin_top_right(agents[this.getI() - 1][this.getJ() + 1].getOpinion());
			this.setMopin_top_light(agents[this.getI() - 1][this.getJ() - 1].getOpinion());
	...
	public void count_neighbors() {
		...
		if (this.getMopin_bottom_right() != null ) {
			
			if (this.getMopin_bottom_right().equals("A")) {
				a = a + 1;
			}
			
			if (this.getMopin_bottom_right().equals("B")) {
				b = b + 1;
			}
		}
		
		if (this.getMopin_bottom_light() != null ) {
			
			if (this.getMopin_bottom_light().equals("A")) {
				a = a + 1;
			}
			if (this.getMopin_bottom_light().equals("B")) {
				b = b + 1;
			}
		}
		
		if (this.getMopin_top_light() != null ) {
			if (this.getMopin_top_light().equals("A")) {
				a = a + 1;
			}
			if (this.getMopin_top_light().equals("B")) {
				b = b + 1;
			}
		}
		
		if (this.getMopin_top_right() != null ) {
			if (this.getMopin_top_right().equals("A")) {
				a = a + 1;
			}
			if (this.getMopin_top_right().equals("B")) {
				b = b + 1;
			}
